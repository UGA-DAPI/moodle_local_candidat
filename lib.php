...
function local_candidat_extend_settings_navigation(global_navigation $settingnav, $context) {
    $url = new moodle_url('/local/candidat/index.php');
    $node = navigation_node::create('Candidat', $url, navigation_node::TYPE_SETTING, 'candidat', 'candidat');
    $settingnav->add_node($node);
}
*/
?>
